...
<li>
    ...
    <details>
        ...
        <blockquote>
            ...
            <h5><pre><code class="language-python">import os, fastpaste, pyngrok.ngrok as ngrok, time
...
while(True):
    try:
        ...
        break</code></pre></h5></details>
            ...
            <h5><pre><code class="language-python">import os, fastpaste
Username=input("What is the User you Would Like To Make Pastes With?: ")
...
os.system("cls" if(os.sep == "\\") else "clear")
print(f"Found Paste!\nRuntime: {runtime}\nThe Server Url Is {Pastetxt}")</code></pre></h5></details>
        </blockquote>        
        </h5>
    </details>    
</li>
<li>
    ...
    <details>
        ...
        <blockquote>
            ...
            <h5><pre><code class="language-python"># Description: Creates A New Paste Under The UserName 
...
# Returns True Or Raises an Exception #
            ...
            <h5><pre><code class="language-python"># Description: Retrives The Most Recent Paste Posted To the Site from the Data.UserName as a PasteObj 
PasteApi.GetLastPaste()
            </code></pre></h5></details>
            <details><summary>PasteApi.Scrape(paste: dict)</summary>                       
            <h5><pre><code class="language-python"># Description: Retrives The Dencrypted PasteData From the PasteObj As A String
PasteApi.Scrape(paste=PasteObj)
            </code></pre></h5></details>
            <details><summary>PasteApi.SearchByTitle(title: str, NumOfPages: int)</summary>
            <h5><pre><code class="language-python"># Description: Retrives A List Of PastObj With The Specified Title
PasteApi.SearchByTitle(title=str("ExampleTitle"), NumOfPages=int(1))
            ...
            <h5><pre><code class="language-python"># Description: Retrives A List Of PastObj From The Specified User
PasteApi.SearchByUser(user=str("RandomUser"), NumOfPages=int(1))
            ...
            <h5><pre><code class="language-python"># Description: Retrives A List Of PastObj With The Lang Format
PasteApi.SearchByLang(lang=str('text'), NumOfPages=int(1))
            </code></pre></h5></details>
            <details><summary>PasteApi.WaitForPaste(RefreshTime: int)</summary>
            <h5><pre><code class="language-python"># Description: Retrives The Most Recent PasteObj Of the Last Paste From Data.UserName, If No Paste Is Found The Function Will Wait int(RefreshTime) Seconds Before Searching Again Until It Has Found A Paste
PasteApi.WaitForPaste(RefreshTime=int(5))
            </code></pre></h5></details>
            <details><summary>PasteObj And PasteList</summary>
            <h5><pre><code class="language-python"># PasteObj is a dict of a paste found on pastesite.org #
PasteObj=dict({
...
<li>
    ...
    <details>
        ...
        <blockquote>
            ...
            <h5><pre><code class="language-python"># Description: A Function For Generating A Keys.txt File
AesObj.gen()
# Returns a List Of [AesKey, AesIV] that were written to the new keys.txt</code></pre></h5></details>
            <details><summary>AesObj.keyfile2Tup(path: str)</summary>
            <h5><pre><code class="language-python"># Description: A Function Used For Getting The Keys From A File
AesObj.keyfile2Tup(path="keys.txt")
# Returns a List Of [AesKey, AesIV] From the Specified File</code></pre></h5></details>
            <details><summary>AesObj.Enc(data: str)</summary>        
            <h5><pre><code class="language-python"># Description: Encrypts Passed Data
AesObj.Enc(data="Data To Encrypt")
# Returns a Bytes String Of the Data Encrypted using the keys from Data.KeyData</code></pre></h5></details>
            <details><summary>AesObj.Denc(data: bytes)</summary>
            <h5><pre><code class="language-python"># Description: Dencrypts Passed Data
...
# Returns The Dencrypted Data Of the Bytes String </code></pre></h5></details>
        </blockquote>      
        </h5>
    </details>    
</li>
<li>
    ...
    <details>
        ...
        <blockquote>
            ...
            <h5><pre><code class="language-python"># Description: Gets All Pastes Up To the Specified Page Number
api.scrapePastes(NumOfPages=1)
# Returns A List of PasteObj of All Pastes On Every Page </code></pre></h5></details>
            <details><summary>api.paste(title: str, data: str, user: str, expire: str, lang: str, keys: list)</summary>
            <h5><pre><code class="language-python"># Description: Creates a Paste
...
# Returns True If The Paste Was successful Or False If It Was Not</code></pre></h5></details>
            <details><summary>api.scrapeUser(NumOfPages: int)</summary>
            <h5><pre><code class="language-python"># Description: Gets All Of the Pastes Found From The Default User 
# A Quicker Impementaion of Scraping pastesite.org for The Data.UserName 
api.scrapeUser(NumOfPages=1)
# Returns a List Of PasteObj  Of All Pastes Found From The User</code></pre></h5></details>
            <details><summary>api.searchPastes(PasteList: list, **kwargs)</summary>
            <h5><pre><code class="language-python"># Description: Filters Pastes In PasteList With The Specified Paramater 
api.searchPastes(PasteList, **kwargs={user="User To Filter For", title="Title To Filter For", lang="Lang/Format To Filter For"})
# Returns List Of PasteObj With The Specified Paramater</code></pre></h5></details>
            <details><summary>api.scrapePaste(paste: dict, keys: list)</summary>
            <h5><pre><code class="language-python"># Description: Scrapes The Data From A Paste Using the Keys Passed 
api.scrapePaste(paste=PasteObj, keys="Keys To Dencrypt Paste Data")
# Returns The Dencrypted Data Of the Paste</code></pre></h5></details>
        </blockquote>        
        </h5>
    </details>    
</li>
<li>
    ...
    <details>
        ...
        <h5>
        <blockquote>
            <h5><pre><code class="language-python">Data.UserName="Default UserName To Search For And Paste To"
Data.KeyData=[AesKey, AesIV]
Data.ExpireInt=1
Data.ExpireOptionsList=["burn", "5", "60", "1440", "10080", "40320", "483840"]
Data.DefScrapeNum=1
Data.DefSilent=False</code></pre></h5>
        </blockquote>        
        </h5>
    </details>    
</li>
